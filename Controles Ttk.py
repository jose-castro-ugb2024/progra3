...
button1 = ttk.Button(master=main, text="Aumentar",command= lambda: Aumentar(), style="button1.TButton")
...
button2 = ttk.Button(master=main, text="Disminuir",command= lambda: Disminuir(), style="button2.TButton")
...
button3 = ttk.Button(master=main, text="Salir",command= lambda: salir(), style="button3.TButton")
